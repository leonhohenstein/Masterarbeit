  ...
  
{
  ...
  if(horizon > 1 & iterative == "replace")
  {
  ...
  out <- out[h:nrow(out),] #removes predictions that were made with the test data and got into the test data set
...
model_name <- c("EN_weekly_iterative_diff_lag_1_sqrt")
